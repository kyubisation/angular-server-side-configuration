...
[Home](./index) &gt; [angular-server-side-configuration](./angular-server-side-configuration.md) &gt; [VariableDetector](./angular-server-side-configuration.variabledetector.md)
